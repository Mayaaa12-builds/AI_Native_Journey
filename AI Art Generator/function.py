...
if __name__ == "__main__":
    ...
    curated_style_names = list(get_user_images_and_style.__annotations__['style_choice'].__forward_args__[0].__args__) # Tries to dynamically get style names
    # Fallback if dynamic retrieval is complex:
    curated_style_names_display = ["Starry Night", "The Scream", "Watercolor Abstract", "Cubist Portrait"]
